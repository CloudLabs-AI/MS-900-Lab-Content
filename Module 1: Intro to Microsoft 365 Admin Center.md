...
# Exercise 1: Admin Experience for User Management
  ...
  In this exercise, you will see how to create users, assign license to the user. Verify custom domains in the tenant and see how to access other admin centers.
